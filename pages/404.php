...
<head>
    ...
    <title>O-o-oh! Something broke.</title>
    <style>@import url(https://fonts.googleapis.com/css?family=Merriweather+Sans);main{height:100vh;width:100vw;background:#fff;display:flex;flex-direction:column;justify-content:center;align-items:center;font-family:"Merriweather Sans",sans-serif}svg{max-width:100%}main #errorText{font-size:22px;margin:14px 0}main #errorLink{font-size:20px;padding:12px;border:1px solid;color:#000;background-color:transparent;text-decoration:none;transition:.5s ease-in-out}main #errorLink:active,main #errorLink:hover{color:#fff;background:#000}main #g6219{transform-origin:85px 4px;-webkit-animation:12s ease-out .5s infinite an1;animation:12s ease-out .5s infinite an1}@-webkit-keyframes an1{0%,100%{transform:rotate(0)}5%{transform:rotate(3deg)}15%{transform:rotate(-2.5deg)}25%,65%{transform:rotate(2deg)}35%,55%{transform:rotate(-1.5deg)}45%{transform:rotate(1deg)}75%{transform:rotate(-2deg)}85%{transform:rotate(2.5deg)}95%{transform:rotate(-3deg)}}@keyframes an1{0%,100%{transform:rotate(0)}5%{transform:rotate(3deg)}15%{transform:rotate(-2.5deg)}25%,65%{transform:rotate(2deg)}35%,55%{transform:rotate(-1.5deg)}45%{transform:rotate(1deg)}75%{transform:rotate(-2deg)}85%{transform:rotate(2.5deg)}95%{transform:rotate(-3deg)}}</style>
</head>
<body>
<main>
 <svg
