...
<head>
    ...
    <link href="/assets/css/style.css?v=1.49" rel="stylesheet">
...
<?php if (isset($multiLanguage) && $multiLanguage === true) { ?>
    ...
    <link rel="alternate" hreflang="vi" href="<?=$isHomeUrl . '/vn' . ''?>" />
    <link rel="alternate" hreflang="tr" href="<?=$isHomeUrl . '/' . 'tr'?>" />
    <link rel="alternate" hreflang="id-ID" href="<?=$isHomeUrl . '/' . 'id'?>" />
    <link rel="alternate" hreflang="fr" href="<?=$isHomeUrl . '/' . 'fr'?>" />
    <link rel="alternate" hreflang="pt" href="<?=$isHomeUrl . '/' . 'pt'?>" />
    <link rel="alternate" hreflang="ru" href="<?=$isHomeUrl . '/' . 'ru'?>" />
    <link rel="alternate" hreflang="es" href="<?=$isHomeUrl . '/' . 'es'?>" />
    <link rel="alternate" hreflang="ar" href="<?=$isHomeUrl . '/' . 'ar'?>" />
    <link rel="alternate" hreflang="ja" href="<?=$isHomeUrl . '/' . 'ja'?>" />
    <link rel="alternate" hreflang="de" href="<?=$isHomeUrl . '/' . 'de'?>" />
    <link rel="alternate" hreflang="it" href="<?=$isHomeUrl . '/' . 'it'?>" />
<? } elseif($isCanonical) {?>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item"><a class="nav-link" aria-current="page" href="#">Merge</a></li>
            <li class="nav-item"><a class="nav-link" aria-current="page" href="#">Split</a></li>
          </ul>
