...
$isLinkLang = isset($_GET['lang']) ? '/' . $_GET['lang'] : '';
...
<head>
  ...
  <? } ?>
    ...
    <link href="/assets/css/style.css?v=1.63" rel="stylesheet">
  ...
  ?>
    ...
    <link rel="alternate" hreflang="vi" href="<?=$isHomeUrl . '/vn' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="tr" href="<?=$isHomeUrl . '/tr' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="id-ID" href="<?=$isHomeUrl . '/id' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="fr" href="<?=$isHomeUrl . '/fr' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="pt" href="<?=$isHomeUrl . '/pt' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="ru" href="<?=$isHomeUrl . '/ru' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="es" href="<?=$isHomeUrl . '/es' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="ko" href="<?=$isHomeUrl . '/ko' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="ja" href="<?=$isHomeUrl . '/ja' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="de" href="<?=$isHomeUrl . '/de' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="it" href="<?=$isHomeUrl . '/it' . ($slug != '' ? '/' . $slug : '')?>" />
    <link rel="alternate" hreflang="th" href="<?=$isHomeUrl . '/th' . ($slug != '' ? '/' . $slug : '')?>" />
<? } elseif($isCanonical) {?>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?=$isLinkLang?>/merge-pdf">Merge PDF</a></li>
                <li><a class="dropdown-item" href="<?=$isLinkLang?>/split-pdf">Split PDF</a></li>
                <li><a class="dropdown-item" href="<?=$isLinkLang?>/word-to-pdf">Word to PDF</a></li>
                <li><a class="dropdown-item" href="<?=$isLinkLang?>/pdf-to-word">PDF to Word</a></li>
                <li><a class="dropdown-item" href="<?=$isLinkLang?>/jpg-to-pdf">JPG to PDF</a></li>
                <li><a class="dropdown-item" href="<?=$isLinkLang?>/pdf-to-jpg">PDF to JPG</a></li>
              </ul>
            </li>
            <li class="nav-item"><a class="nav-link" aria-current="page" href="<?=$isLinkLang?>/merge-pdf">Merge</a></li>
            <li class="nav-item"><a class="nav-link" aria-current="page" href="<?=$isLinkLang?>/split-pdf">Split</a></li>
          </ul>
