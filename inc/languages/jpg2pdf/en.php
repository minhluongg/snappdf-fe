...
$merge['potrait'] = "Potrait";
$merge['landscape'] = "Landscape";
$merge['pagesize'] = "Page size";
$merge['margin'] = "Margin";
$merge['no-margin'] = "No margin";
$merge['small'] = "Small";
$merge['big'] = "Big";
$merge['mergeonepdf'] = "Merge all images in one PDF file";
$merge['output-setting'] = "Output Setting";