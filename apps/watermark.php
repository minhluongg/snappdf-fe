                ...
                <div class="setting-main">
                    <div class="radio-toggle mt-3 p-c border-none">
                        ...
                        <div class="row mt-3 watermark-tabs">
                            <div class="col-12 add-text">
                                ...
                                <input type="text" name="text" class="form-control" placeholder="SnapPDF">
                                <div class="font-settings">
                                    <div class="row">
                                        ...
                                        <div class="col-5 font-size">
                                            ...
                                            <select name="margin" class="form-select" aria-label="Margin" id="isMargin">
                                                <option value="none">14</option>
                                                <option value="medium" selected="">16</option>
                                    ...
                                    <div class="font-style">
                                        <div class="fontstyle-item">
                                            <input class="hide-input" type="radio" name="font_style" value="Bold" id="fontstyle-1">
                                        ...
                                        <div class="fontstyle-item">
                                            <input class="hide-input" type="radio" name="font_style" value="image" id="fontstyle-2">
                                        ...
                                        <div class="fontstyle-item">
                                            <input class="hide-input" type="radio" name="font_style" value="image" id="fontstyle-3">
                                        ...
                                        <div class="fontstyle-item">
                                            <input class="hide-input" type="radio" name="font_style" value="image" id="fontstyle-4">
                                            <label for="fontstyle-4">
                    ...
                    <div class="setting-box mt-3 p-c add-number">
                        ...
                        <div class="page-margin">
                            ...
                            <select name="margin" class="form-select" aria-label="Margin" id="isMargin">
                                <option value="medium" selected>Over the PDF content</option>
                                <option value="large">Below the PDF content</option>
                            </select>
                        </div>
