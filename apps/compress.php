                ...
                <div class="setting-main">
                    ...
                    <div class="radio mt-2">
                        <div class="radio-item">
                            <input class="hide-input" type="radio" name="compress_level" value="low" id="compress_low"/>
                            <label for="compress_low">
                                <div class="label-info">
                                    <div class="label-title">High compression</div>
                                    <span class="label-subtitle">Less quality</span>
                                </div>
                        ...
                        <div class="radio-item">
                            <input class="hide-input" type="radio" name="compress_level" value="medium" id="compress_medium" checked="checked"/>
                            <label for="compress_medium">
                                <div class="label-info">
                                    <div class="label-title">Recommended compression</div>
                                    <span class="label-subtitle">Good quality</span>
                                </div>
                                <div class="circle"></div>
                            </label>
                        </div>
                        <div class="radio-item">
                            <input class="hide-input" type="radio" name="compress_level" value="high" id="compress_high" />
                            <label for="compress_high">
                                <div class="label-info">
                                    <div class="label-title">Less compression</div>
                                    <span class="label-subtitle">High quality</span>
                                </div>
                                <div class="circle"></div>
                            </label>
                        </div>
...
function handleConvert() {
    ...
    var isCompressLevel = $('input[name=compress_level]:checked').val();
    var items = getItems();
    ...
    var dataSend = {
            ...
            "files": items,
            "config": {
                "compress_level": isCompressLevel
            }
		};
    getTaskId(dataSend);
}
